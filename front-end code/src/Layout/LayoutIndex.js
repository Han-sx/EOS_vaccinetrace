...
import Add1 from "../Table/ActionTable/Add1";
import Update1 from "../Table/ActionTable/Update1";
import Erase1 from "../Table/ActionTable/Erase1";
        ...
        <Layout>
          <Sider width={200} className="site-layout-background">
            ...
            >
              ...
              >
                <Menu.Item key="10">option5</Menu.Item>
                <Menu.Item key="11">option6</Menu.Item>
                <Menu.Item key="12">option7</Menu.Item>
                <Menu.Item key="13">option8</Menu.Item>
              </SubMenu>
              <SubMenu
                key="sub4"
                title={
